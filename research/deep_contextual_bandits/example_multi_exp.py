...
from bandits.core.contextual_bandit import run_contextual_bandit, run_mixup_contextual_bandit, run_random_mixup_contextual_bandit, run_contrast_mixup_contextual_bandit
...
def main(_):
  ...
  for i in range(2):
    ...
    for i in [al1, al2, al3, al4]:
      i[0].update_freq_lr=10
      i[0].update_freq_nn=50
